...
<script>
    function toSubmit(){
        ...
        var gameCreateTime = $("[name='gameCreateTime']").val()
        //测试用
        // alert(producerId+gameName+","+gameType+","+gameAge+","+gamePrice+","+gameDiscount+","+gameIntroduction)

        $.ajax({
            url:"http://localhost:8080/user?method=toChangeGame",
            type:"post",
            data:{
    ...
    $(function (){
        $('#gameAge option[value="${chsOnlineGame.age}"]').prop("selected",'selected')
        $('#gameType option[value="${chsOnlineGame.type}"]').prop("selected",'selected')
    })
</script>
<body>
<!--引入头部div-->
        ...
        <div id="content_main_table">
            <table class="gradient-style">
                ...
                <tr>
                    <td>开发者名称：</td>
                    <td>
                        <input type="text" name="producerId" readonly  unselectable="on" value="${loginUser.username}">
                    </td>
                </tr>
                <tr>
                    <td>游戏ID：</td>
                ...
                <tr>
                    <td>游戏名称：</td>
                    <td>
                        <input type="text" name="gameName" value="${chsOnlineGame.name}">
                    </td>
                </tr>
                <tr>
                    <td>游戏上架时间：</td>
                    <td>
                        <input type="text" name="gameCreateTime" readonly  unselectable="on" value="${chsOnlineGame.time}">
                    </td>
                </tr>
                <tr>
                    <td>游戏类型：</td>
                ...
                <tr>
                    <td>游戏分级：</td>
                    <td>
                        <select name="gameAge" id="gameAge">
                ...
                <tr>
                    <td>游戏价格：</td>
                    <td>
                        <input type="text" name="gamePrice" readonly  unselectable="on" value="${chsOnlineGame.price}">
                    </td>
                </tr>
                <tr>
                    <td>游戏折扣：</td>
                    <td>
                        <input type="text" name="gameDiscount" value="${chsOnlineGame.discount}">&nbsp;&nbsp;%
                    </td>
                </tr>
            </table>
        </div>
        <div id="content_main_info">
            ...
            <table class="gradient-style">
                <tr>
                    <td>游戏介绍：</td>
                    <td>
                        <textarea rows="6" cols="50" name="gameIntroduction">${chsOnlineGame.introduction}</textarea>
                    </td>
                </tr>
            </table>
        </div>
